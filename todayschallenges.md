...
#### We've been doing these steps manually. How could we automate some of them?
...
# Change this to your current EC2 public IPv4 address
EC2_IP="108.132.7.162"

# EC2 username for Ubuntu AMI
EC2_USER="ubuntu"

# Path to your private key on your main PC
KEY="$HOME/.ssh/montezer-tech610-key.pem"

# Path to your TicTacToe zip file on your main PC
